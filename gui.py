...
class gui:
    ...
    def __init__(self, root):
        ...
        Label(frame, text=" | ", foreground="black",
              background="white").grid(row=0, column=5)

        self.snap_button = Button(frame, text="[F1-4] Snap: Off")
        self.snap_button.grid(row=0, column=6)

        Label(frame, text=" | ", foreground="black",
              background="white").grid(row=0, column=7)
        ...
        Label(frame, text=" | ", foreground="black",
              background="white").grid(row=0, column=10)

        self.help_button = Button(frame, text="?", command=self.toggle_help)
        ...
        self.help_label = Label(self.canvas, text="", bg="white", justify=LEFT)
